...
public class FusionPointConnector implements PlatformConnector {
    private static final String PLATFORM = "fusionpoint";
    private static final String LOGIN_URL = "https://www.fpsports.org/Login.aspx";
    private static final String CHECK_URL = "https://www.fpsports.org/";

    private final SessionStore sessionStore;
    private final DatabaseManager db;

    public FusionPointConnector(SessionStore sessionStore, DatabaseManager db) {
