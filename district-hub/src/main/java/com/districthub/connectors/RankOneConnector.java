...
public class RankOneConnector implements PlatformConnector {
    private static final String PLATFORM = "rankone";
    private static final String LOGIN_URL = "https://www.rankonesport.com/";
    private static final String CHECK_URL = "https://www.rankonesport.com/";

    private final SessionStore sessionStore;
    private final DatabaseManager db;

    public RankOneConnector(SessionStore sessionStore, DatabaseManager db) {
