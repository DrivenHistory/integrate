...
public class BoundConnector implements PlatformConnector {
    private static final String PLATFORM = "bound";
    private static final String LOGIN_URL = "https://login.gobound.com/account/LoginEnterEmail";
    private static final String CHECK_URL = "https://login.gobound.com/";

    private final SessionStore sessionStore;
    private final DatabaseManager db;

    public BoundConnector(SessionStore sessionStore, DatabaseManager db) {
