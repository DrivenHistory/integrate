...
public class VantageConnector implements PlatformConnector {
    private static final String PLATFORM = "vantage";
    private static final String LOGIN_URL = "https://www.leagueminder.com/";
    private static final String CHECK_URL = "https://www.leagueminder.com/";

    private final SessionStore sessionStore;
    private final DatabaseManager db;

    public VantageConnector(SessionStore sessionStore, DatabaseManager db) {
